...
export const EDUCATION: CvItem[] = [
  {
    ...
    description: 'I was part of the Foundever Top-Talent Program, an exclusive three-year development program in which a select group of promising talents was intensively supported each year. During my participation, I completed numerous internal and external workshops focused on personal and professional growth, covering topics such as self-efficacy, resilience, time management, and leadership skills. In addition, I collaborated closely with other talents on group projects, including the design of an internal suggestion system and the development of an innovative business model for a BPO company. These experiences significantly strengthened my teamwork, creative thinking, and project management skills, providing valuable insights for my professional development.',
...
export const PROJECTS: CvItem[] = [
  ...
  },
  {
    ...
    description: 'During the COVID-19 pandemic, the shift of 7,000 employees to remote work presented new logistical challenges, particularly in efficient hardware distribution and device replacement. In collaboration with our W@H Director, I led the design and implementation of a fulfillment center at our Krefeld site. My responsibilities included selecting and optimizing inventory management software, building a high-performing team, and training employees. Today, the center is a key part of the W@H strategy—requests that previously took 3–10 days are now processed on the same day in 90% of cases. This project enhanced my expertise in project management, process optimization, and team development.',
